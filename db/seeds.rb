...
def generate_post
  10.times do
    post = Post.create(title: "#{PREFIX.sample} #{CONTENT.sample} #{"게시글"}", description: Faker::Lorem.sentence(word_count: 200), user_id: rand(2..7), filter_id: rand(40..60), price: "#{PRICES.sample}", likers_count: rand(9000))
    10.times do
